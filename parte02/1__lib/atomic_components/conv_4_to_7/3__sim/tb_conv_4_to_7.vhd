...
-- Entity Definition
ENTITY TB_CONV_4_TO_7 IS

		
END ENTITY TB_CONV_4_TO_7;

-- Architecture definition
ARCHITECTURE BEHAVIORAL OF TB_CONV_4_TO_7 IS
...
BEGIN
	...
	X<= "1101";
	wait for 10 ns;
	assert (Y = "1111111") report "Test Case 13 Failed" severity error;
