...
BEGIN
	...
	X10 <= '0';
	wait for 10 ns;
        assert (Y0 = "00000000") report "Test Case 0 Failed" severity error;
	...
	X10 <= '0';
	wait for 10 ns;
        assert (Y0 = "00000001") report "Test Case 1 Failed" severity error;
	...
	X10 <= '0';
	wait for 10 ns;
        assert (Y0 = "00000010") report "Test Case 2 Failed" severity error;
	...
	X10 <= '0';
	wait for 10 ns;
        assert (Y0 = "00000000") report "Test Case 3 Failed" severity error;
